...
<html xml:lang="zh-CN" xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN"><head>
  ...
  <title><?php echo $this->session->userdata('name');?>的博客 - SYSIT个人博客</title>
...
<div id="OSC_Banner">
    ...
    <div class="clear"></div>
	  ...
	  <div id="VisitorInfo">
		当前访客身份：
				<?php echo $this->session->userdata('name');?> [ <a href="blog/ind">退出</a> ]
				<span id="OSC_Notification">
			<a href="blog/do_inbox" class="msgbox" title="进入我的留言箱">你有<em>0</em>新留言</a>
																				</span>
</div>
		<div id="SearchBar">
    		<form action="#">
    ...
    <div id="lnks">
		...
		<div><a href="blog/index">TA的博客列表</a>&nbsp;|
			<a href="message/send">发送留言</a></div>
	</div>
	<div class="clear"></div>
</div>
<div class="BlogList">
...
?>
	...
	<h2 class="BlogAccess_true BlogTop_0"><a href="blog/view_blog/<?php echo $v->BLOG_ID?>"><?php echo $v->TITLE?></a></h2>
	<div class="outline">
	  ...
	  <span class="stat">统计: <?php echo $v->COMM_RATE?>评/<?php echo $v->CLICK_RATE?>阅</span>
	  	  <span class="blog_admin">( <a href="newBlog.htm">修改</a> | <a href="blog/del_blog/<?php echo $v->BLOG_ID?>">删除</a> )</span>	  
	  	</div>
		<div class="TextContent" id="blog_content_24027">
				<?php echo $v->CONTENT?>
		<div class="fullcontent"><a href="blog/view_blog/<?php echo $v->BLOG_ID?>">阅读全文...</a></div>
			</div>
	  </li>
<?php
	}?>
...
<div class="BlogMenu"><div class="admin SpaceModule">
  <strong>博客管理</strong>
  <ul class="LinkLine">
	<li><a href="blog/insert_blog">发表博客</a></li>
