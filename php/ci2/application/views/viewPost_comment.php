...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
  ...
  <title>测试文章2 -  <?php echo $this->session->userdata('name')?>的博客 - SYSIT个人博客</title>
...
<div id="OSC_Banner">
    ...
    <div class="clear"></div>
	  ...
	  <div id="VisitorInfo">
		当前访客身份：
				<?php echo $this->session->userdata('name')?> [ <a href="user/login">登录</a> | <a href="user/reg">注册</a> ]
...
<div class="Blog">
  ...
  <div class="BlogTitle">
    ...
    <div class="BlogStat">
						<span class="admin">
			<a href="newBlog.htm">编辑</a>&nbsp;|&nbsp;<a href="blog/del_blog/<?php echo $result->BLOG_ID?>">删除</a>
		</span>
				发表于1小时前 , 
		已有<strong><?php echo $result->CLICK_RATE?></strong>次阅读  
		共<strong><a href="#comments"><?php echo $result->COMM_RATE?></a></strong>个评论
  ...
  <div class="BlogContent TextContent"><?php echo $result->CONTENT?></div>
    ...
    <h2><a name="comments" href="#postform" class="opts">发表评论»</a>共有 <?php echo $result->COMM_RATE?> 条网友评论</h2>
			<ul id="BlogComments">
